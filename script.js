document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'exp.pgie.b1': 'Supported the company\'s day-to-day recruitment and administrative work across 3 core departments.',
            'exp.pgie.b2': 'Reviewed 80+ applications, contacted top candidates, and arranged 15+ interviews weekly.',
            'exp.pgie.b3': 'Helped prepare onboarding documents and updated recruitment records for new hires.',
            'exp.pgie.b4': 'Assisted with routine personnel administration, processing 20+ employee requests weekly.',

            'exp.assoc2.role': 'Volunteer & Coordinator',
            'exp.assoc2.title': 'Volunteering & Community Initiatives',
            'exp.assoc2.date': 'Sept 2022 - Sept 2024 | Białystok, Poland',
        ...
        pl: {
            ...
            'exp.pgie.b1': 'Wspieranie codziennych procesów rekrutacyjnych oraz prac administracyjnych firmy w obrębie 3 kluczowych działów.',
            'exp.pgie.b2': 'Weryfikacja ponad 80 aplikacji, kontaktowanie się z kandydatami i umawianie ponad 15 rozmów kwalifikacyjnych tygodniowo.',
            'exp.pgie.b3': 'Pomoc w przygotowywaniu dokumentów onboardingowych oraz aktualizowanie baz danych rekrutacyjnych dla nowo zatrudnionych pracowników.',
            'exp.pgie.b4': 'Asystowanie przy bieżących zadaniach z zakresu administracji kadrowej, procesowanie ponad 20 wniosków pracowników tygodniowo.',

            'exp.assoc2.role': 'Wolontariusz i Koordynator',
            'exp.assoc2.title': 'Wolontariat i inicjatywy społeczne',
            'exp.assoc2.date': 'Wrzesień 2022 - Wrzesień 2024 | Białystok, Polska',
